...
%
% Windenergie_Praktikum_LiveSkript_final.mlx
%
% Daten/
%
...
function showIntegratedMusterloesung(windStats, monthly, sectorTable, ...
    ...
    fprintf('1. Windreichster Monat: %s (%.2f m/s). Windärmster Monat: %s (%.2f m/s).\n', ...
        char(monthly.Monat(iMax)),monthly.Mittelwert_mps(iMax), ...
        char(monthly.Monat(iMin)),monthly.Mittelwert_mps(iMin));
    possibleAnswer(2, ...
    ...
    possibleAnswer(2, ...
        "Die Häufigkeit höherer Windgeschwindigkeiten muss getrennt von der Gesamthäufigkeit betrachtet werden. Dominante Richtungen können ähnlich sein, ihre Anteile können sich jedoch unterscheiden.");
    possibleAnswer(3, ...
    ...
    possibleAnswer(1, ...
        "Der erkennbare Leistungsanstieg beginnt im Bereich oberhalb der Einschaltwindgeschwindigkeit, stimmt aber wegen Anfahrvorgängen, Regelung und Messstreuung nicht mit einem einzelnen scharfen Grenzwert überein.");
    possibleAnswer(2, ...
    ...
    possibleAnswer(2, ...
        "Der erkennbare elektrische Leistungsanstieg setzt später als die erste Rotorbewegung ein. Rotation und nutzbare elektrische Erzeugung sind daher nicht gleichzusetzen.");
    possibleAnswer(3, ...
    ...
    if ~isempty(weibullParameters)
        ...
        possibleAnswer(1, ...
            "Die größten Abweichungen sind anhand des Diagramms insbesondere in den Bereichen zu beurteilen, in denen die Balkenhöhen des Histogramms sichtbar von der angepassten Weibull-Kurve abweichen.");
